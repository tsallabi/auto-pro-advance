                    ...
                    <div className="space-y-10 animate-in slide-in-from-right duration-1000">
                        <div className="flex flex-col gap-6 items-start">
                            <div className="relative group">
                                {/* Backglow Effect */}
                                <div className="absolute inset-0 bg-orange-500/20 blur-[60px] rounded-full -z-10 animate-pulse"></div>
                                <img 
                                    src="/logo.jpg" 
                                    alt="AutoPro Logo" 
                                    className="h-20 lg:h-24 w-auto object-contain rounded-2xl shadow-2xl shadow-orange-500/10 border border-white/5 bg-white/5 backdrop-blur-sm p-1"
                                />
                            </div>
